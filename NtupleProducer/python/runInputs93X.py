...
process = cms.Process("IN", eras.Phase2_trigger, convertHGCalDigisSim)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/cms/store/cmst3/user/gpetrucc/SinglePion_FlatPt-2to100_L1TnoPU_93X_upgrade2023_realistic_v5-v1_6CE2DACD-B437-E811-BDF0-001E677927B0.root'),
...
process.out = cms.OutputModule("PoolOutputModule",
        fileName = cms.untracked.string("inputs93X.root"),
