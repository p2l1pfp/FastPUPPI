...
void makePlots_v3(//mettree_pt3_dR04_NoLep_200",upmet_nomu_dz_nocut.root
		  std::string iFile0="pupmet_fix2_28.root",
		  std::string iFile1="pupmet_fix2_28.root",
		  std::string iFile2="pupmet_fix2_28.root",
		  std::string iFile3="pupmet_fix2_28.root"
	       ) {  
  //Prep();
  setTDRStyle();
  std::string lLabel="";
  ...
  makeMETPlotsFile(lLabel_b+"u2"+lLast,lLabel2_b,iFile0,kRed);
