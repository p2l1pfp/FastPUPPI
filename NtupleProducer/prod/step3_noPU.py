...
# with command line options: step3_noPU_v2 --conditions auto:phase2_realistic -n -1 --era Phase2C2 --eventcontent FEVTDEBUGHLT,MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,PAT --datatier GEN-SIM-RECO,MINIAODSIM --geometry Extended2023D3 --filein file:step2.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_np.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3_noPU nevts:10'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_FEVT_np.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_MINIAODSIM.root'),
...
if len(args) == 1:
    process.source.fileNames = [ "file:"+args[0]+"_step2.root" ]
    process.FEVTDEBUGHLToutput.fileName = args[0]+"_FEVT.root"
    process.MINIAODSIMoutput.fileName = args[0]+"_MINIAODSIM.root"
