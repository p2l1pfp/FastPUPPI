#ifndef XCommonTools_PileupAlgos_PuppiAlgo_h
#define XCommonTools_PileupAlgos_PuppiAlgo_h
...
public:
  ...
  void   add(const combiner::Particle &iParticle,const double &iVal,const unsigned int iAlgo);
